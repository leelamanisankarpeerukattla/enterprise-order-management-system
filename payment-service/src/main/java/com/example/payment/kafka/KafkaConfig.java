...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, PaymentRequestedEvent> paymentRequestedConsumerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrap) {
        JsonDeserializer<PaymentRequestedEvent> json = new JsonDeserializer<>(PaymentRequestedEvent.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, PaymentRequestedEvent> paymentRequestedKafkaListenerContainerFactory(
        ...
        ConcurrentKafkaListenerContainerFactory<String, PaymentRequestedEvent> f = new ConcurrentKafkaListenerContainerFactory<>();
