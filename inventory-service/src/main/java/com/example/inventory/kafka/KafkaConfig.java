...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, OrderCreatedEvent> orderCreatedConsumerFactory(@Value("${spring.kafka.bootstrap-servers}") String bootstrap) {
        JsonDeserializer<OrderCreatedEvent> json = new JsonDeserializer<>(OrderCreatedEvent.class);
    ...
    public ConcurrentKafkaListenerContainerFactory<String, OrderCreatedEvent> orderCreatedKafkaListenerContainerFactory(
        ...
        ConcurrentKafkaListenerContainerFactory<String, OrderCreatedEvent> f = new ConcurrentKafkaListenerContainerFactory<>();
